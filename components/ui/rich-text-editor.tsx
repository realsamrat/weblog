...
export function RichTextEditor({ 
  ...
  // Simple editor safety check - similar to mui-tiptap approach
  const isEditorSafe = (editor: Editor | null): boolean => {
    return !!(editor && !editor.isDestroyed && editor.view && editor.commands)
  }
  ...
  // Simple content initialization effect
  useEffect(() => {
    if (editor && content && !editorInitialized.current && isEditorReady) {
      try {
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                disabled={!isEditorSafe(editor) || !safeCanExecute('undo')}
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                disabled={!isEditorSafe(editor) || !safeCanExecute('redo')}
              >
