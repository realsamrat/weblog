...
if (!process.env.DATABASE_URL) {
  console.log('\n⚠️  WARNING: DATABASE_URL is not set. Database connection will fail.')
}

if (!process.env.NEXT_PUBLIC_SANITY_PROJECT_ID) {
  console.log('\n⚠️  WARNING: NEXT_PUBLIC_SANITY_PROJECT_ID is required for Sanity CMS.')
}

if (!process.env.NEXT_PUBLIC_SANITY_DATASET) {
  console.log('\n⚠️  WARNING: NEXT_PUBLIC_SANITY_DATASET is required for Sanity CMS.')
}
